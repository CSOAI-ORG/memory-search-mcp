<!-- mcp-name: CSOAI-ORG/memory-search-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/memory-search-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/memory_search_mcp/)
...
- [Full Documentation](https://docs.meok.ai/memory-search-mcp)
...
- "Use `record_memory` to …"
- "Use `search_memory` to …"
- "Use `add_knowledge` to …"
